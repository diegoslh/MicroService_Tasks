...
function ModalCrearTarea({ idModal }) {
  ...
  const cargarDatosModal = async () => {
    try {
      ...
      const pendiente = estadoData.find(e => e.estadoTarea.toLowerCase() === 'pendiente');
        ...
        <div className="modal-dialog">
          <form className="modal-content" onSubmit={handleSubmit}>
            ...
            <section className="modal-body">
              <div className="mb-3">
                <label className="form-label">Título <code>*</code></label>
                <input
                  type="text"
                  name="titulo"
                  maxLength="100"
              ...
              <div className="mb-3">
                <label className="form-label">Fecha Límite <code>*</code></label>
                <input
                  type="date"
                  name="fechaLimite"
                  className="form-control"
              ...
              <div className="mb-3">
                <label className="form-label">Colaborador <code>*</code></label>
                <select
                  name="colaboradorFk"
            ...
            <footer className="modal-footer">
              ...
              <button type="submit" className="btn btn-success" disabled={!estadoCargado}>
                Crear Tarea
              </button>
            </footer>
          </form>
